                   ...
                   "basicVowels":  [
                                       {
                                           ...
                                           "strokes":  [
                                                           {
                                                               "id":  "a-1",
                                                               "centerPath":  "M12.01 18.97 L19.61 18.55 L25.94 18.55 L32.27 18.55 L37.34 14.33 L42.4 18.13 L53.38 17.71 L65.2 16.86 L73.64 16.02 L79.97 15.18",
                                                               "points":  [
                                                                              {
                                                                                  "x":  12.01,
                                                                                  "y":  18.97
                                                           ...
                                                           {
                                                               "id":  "a-2",
                                                               "centerPath":  "M37.76 8.0 L37.34 14.33 L42.4 18.13 L32.27 18.55 L36.49 23.62 L36.49 29.95 L36.49 36.28 L42.82 40.08 L36.49 42.61 L31.85 47.26 L37.34 50.63 L37.76 56.96 L38.6 63.3 L41.14 69.63 L42.4 75.96 L39.03 82.29 L32.27 84.82",
                                                               "points":  [
                                                                              {
                                                                                  "x":  37.76,
                                                                                  "y":  8.0
                                                           ...
                                                           {
                                                               "id":  "a-3",
                                                               "centerPath":  "M63.93 35.44 L74.06 41.77 L84.61 49.37 L88.83 61.61 L88.83 67.94 L87.15 74.27 L83.77 80.18 L79.13 84.82 L73.22 88.2 L66.04 90.73 L59.29 92.0 L50.0 88.62 L45.36 83.98 L39.03 82.29 L32.27 84.82 L25.52 86.93 L18.34 87.36 L13.28 83.56 L11.17 77.23 L11.17 70.89 L12.85 64.56 L15.81 58.65 L20.03 53.59 L25.1 48.94 L31.85 47.26 L42.82 40.08 L50.0 39.24 L56.33 39.24",
                                                               "points":  [
                                                                              {
                                                                                  "x":  63.93,
                                                                                  "y":  35.44
      ...
      <div class="hiraganaBoardWrap">
        <svg id="hiraganaBoard" class="hiraganaBoard" viewBox="${letter.viewBox}" aria-label="ひらがなのなぞり書き">
          ...
          <g class="hiraganaGhostPaths" aria-hidden="true">
            ${letter.strokes.map(stroke => `<path class="hiraganaGhostPath" data-stroke-id="${stroke.id}" d="${stroke.centerPath || stroke.path}" fill="none" stroke-linecap="round" stroke-linejoin="round" />`).join("")}
          </g>
